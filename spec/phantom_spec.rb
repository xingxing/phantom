...
describe Phantom do
  ...
  describe ".create" do
    ...
    context "when 截取成功" do
      ...
      it "should 返回hash{success: 1, url: '/images/3/1/7/c/8/317c86ee553826fe782fd3abcd1bbb65.jpg'}" do
        expect(Phantom.create(url: url, formate: 'jpg')).to eql({success: 1, url: '/images/1/a/2/b/3/1a2b3123123123.jpg'})
      end
    end
